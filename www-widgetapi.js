...
return d}
t("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/Array.prototype.keys",function(a){return a?a:function(){return Ca(this,function(b){return b})}});
...
t("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/Object.is",function(a){return a?a:function(b,c){return b===c?0!==b||1/b===1/c:b!==b&&c!==c}});
...
Ab&&(zb=Ab?Ab[1]:"");if(tb){var Bb=xb();if(null!=Bb&&Bb>parseFloat(zb)){yb=String(Bb);break a}}yb=zb}var Cb=yb,Db;if(A.document&&tb){var Eb=xb();Db=Eb?Eb:parseInt(Cb,10)||void 0}else Db=void 0;var Fb=Db;var Gb=H("iPhone")&&!H("iPod")&&!H("iPad")||H("iPod"),Hb=H("iPad");var Ib={},Jb=null;var I=window;function Kb(a){var b=C("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/window.location.href");null==a&&(a='Unknown Error of type "null/undefined"');if("string"===typeof a)return{message:a,name:"Unknown error",lineNumber:"Not available",fileName:b,stack:"Not available"};var c=!1;try{var d=a.lineNumber||a.line||"Not available"}catch(g){d="Not available",c=!0}try{var e=a.fileName||a.filename||a.sourceURL||A.$googDebugFname||b}catch(g){e="Not available",c=!0}b=Lb(a);if(!(!c&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name)){c=a.message;if(null==
...
function Bd(a){var b=C("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/yt.logging.errors.log");b?b(a,"ERROR",void 0,void 0,void 0):(b=O("ERRORS",[]),b.push([a,"ERROR",void 0,void 0,void 0]),xd("ERRORS",b))}
function Cd(a){var b=C("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/yt.logging.errors.log");b?b(a,"WARNING",void 0,void 0,void 0):(b=O("ERRORS",[]),b.push([a,"WARNING",void 0,void 0,void 0]),xd("ERRORS",b))}
...
function Pe(a){var b=window.location.search,c=J(a),d=Vb(a.match(Ub)[5]||null);d=(c=c&&(c.endsWith("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/youtube.com")||c.endsWith("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=Od(b),f={};G(Me,function(g){e[g]&&(f[g]=e[g])});
return Pd(a,f||{},!1)}
...
function af(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||O("VISITOR_DATA","")};if(b&&b.includes("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/www.youtube-nocookie.com"))return d;(b=c.Ba||O("AUTHORIZATION"))||(a?b="Bearer "+C("gapi.auth.getToken")().Aa:b=kc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=O("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=O("DELEGATED_SESSION_ID")));return d}
...
df.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,D()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Nc(b))}catch(f){return}else e=escape(b);b=this.g;Pb.set(""+a,e,{U:c,path:"/",domain:void 0===b?"https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/youtube.com":b,secure:!1})};
...
df.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;Pb.remove(""+a,"/",void 0===b?"https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/youtube.com":b)};var ef;function ff(){ef||(ef=new df);return ef}
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.f.ja)&&(g=e);var k=a.f.la||!1,h=af(k,g,d);Object.assign(f.headers,h);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.f.innertubeApiVersion+"/"+b;var l={alt:"json"};a.f.ka&&f.headers.Authorization||(l.key=a.f.innertubeApiKey);var m=Pd(""+g+e,l||{},!0);ig().then(function(n){if(d.retry&&S("retry_web_logging_batches")&&"https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/www.youtube-nocookie.com"!=g){if(S("networkless_gel")&&!n||!S("networkless_gel"))var r=gf(b,
...
u(d.O[f.name]),k=h.next();!k.done;k=h.next())if(n=k.value,k=f.message.match(n.regexp)){f.params["error.original"]=k[0];h=n.groups;n={};for(m=0;m<h.length;m++)n[h[m]]=k[m+1],f.params["error."+h[m]]=k[m+1];f.message=d.V(n);break}window.yterr&&"function"===typeof window.yterr&&window.yterr(f);if(!(og.has(f.message)||0<=f.stack.indexOf("YouTubeCenter.js"/*tpa=https://s.ytimg.com/YouTubeCenter.js*/)||0<=f.stack.indexOf("mytube.js"/*tpa=https://s.ytimg.com/mytube.js*/))){if(S("kevlar_gel_error_routing")){g=void 0;k=e;n=f;h={stackTrace:n.stack};n.fileName&&(h.filename=n.fileName);
...
;E("YT.PlayerState.UNSTARTED",-1);E("YT.PlayerState.ENDED",0);E("YT.PlayerState.PLAYING",1);E("YT.PlayerState.PAUSED",2);E("YT.PlayerState.BUFFERING",3);E("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/YT.PlayerState.CUED",5);E("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/YT.get",function(a){return Sd[a]});
E("https://s.ytimg.com/yts/jsbin/www-widgetapi-vflOHiu0I/YT.scan",Vd);E("YT.subscribe",function(a,b,c){gd.subscribe(a,b,c);Ud[a]=!0;for(var d in Sd)tg(Sd[d],a)});
